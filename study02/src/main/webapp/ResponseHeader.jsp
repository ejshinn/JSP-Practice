...
<%
    ...
    // ddDateHeader(key, value) : 지정한 키와 값을 헤더에 날짜 타입으로 저장
    ...
    // getHeader()를 통해서 데이터를 가져올 경우 첫 번째로 검색되는 데이터만 출력됨
    // 두 번째 세 번째와 같이 다른 데이터도 함께 출력하고자 할 경우 getHeaders()를 통해서 가져와야 함
