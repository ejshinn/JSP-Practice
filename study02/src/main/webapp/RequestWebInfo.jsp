...
<head>
    ...
    <title>request 객체 (RequestWebInfo.jsp)</title>
...
<body>
    <div class="container mt-5">
        ...
        <ul class="list-group">
            <%-- request : jsp가 미리 선언하여 사용자가 사용할 수 있도록 해놓은 내장 객체, 요청 데이터를 저장 --%>
            ...
            <%-- Protocol(프로토콜) : 컴퓨터나 원거리 통신 장비 사이에서 메시지를 주고받기 위한 통신 규약 --%>
            ...
            <%-- getQueryString() : URI 뒤에 있는 ? 기호와 함께 전달된 데이터를 의미, GET 방식 사용 시 URL과 함께 전달된 데이터를 출력, POST 방식 사용 시 쿼리스트링은 null임 --%>
