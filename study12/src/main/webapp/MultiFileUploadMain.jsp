...
<div class="container mt-5">
    ...
    <%-- EL을 사용하여 request 영역에 저장된 errorMessage 변수를 출력, 있으면 출력 없으면 표시 안 함 --%>
    <span class="text-danger">${errorMessage}</span>

    <div class="row">
        <div class="col-sm-4 mx-auto">
            <%-- /MultiUploadProcess.do라는 서블릿으로 접속, 전송 방식을 multipart 타입으로 전달, file 업로드 시 필수 --%>
            <form action="/MultiUploadProcess.do" method="post" enctype="multipart/form-data">
                ...
                <div class="my-3">
                    <label for="file" class="form-label">첨부 파일(다중선택가능) : </label>
                    <%-- input 태그의 type이 file이므로 파일을 업로드할 수 있음 --%>
