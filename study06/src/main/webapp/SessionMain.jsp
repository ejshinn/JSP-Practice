...
<%
    ...
    session.setMaxInactiveInterval(30); // 세션 유지 시간 설정
    ...
    // getCreationTime() : 서버에 세션이 최초로 생성된 시각 출력
    // getId() : 서버에 생성된 세션 ID를 출력
    // getLastAccessedTime() : 서버에 세션이 마지막으로 사용된 시각 출력
...
<body>
    <div class="container mt-5">
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">최초 요청 시각 : <%=createTimeStr%></li>
            <li class="list-group-item">마지막 요청 시각 : <%=lastTimeStr%></li>
        </ul>
    </div>
</body>
</html>