        ...
        <div class="row">
            <div class="col-sm">
                <table class="table table-hover table-striped text-center">
                    ...
                    <tbody>
                        <%-- JSTL의 choose를 사용하여 게시물 정보가 있는지 확인 --%>
                        <c:choose>
                            <%-- empty : EL에서 제공하는 연산자, 피연산자가 비어있는지 아닌지 확인 --%>
                            ...
                            <c:otherwise>
                                ...
                                <c:forEach var="item" items="${boardList}" varStatus="loop">
                                    <tr>
                                        <td>${item.idx}</td>
                                        <td class="text-start">
                                            <%-- 제목 부분에 a 태그를 사용하여 /mvcboard/view.do를 사용하는 서블릿으로 이동, 이동 시 게시물의 글 번호을 전달함 --%>
