...
<%-- 게시글 내용을 출력 --%>
<%-- 게시글 내용을 수정 --%>
<%-- form을 통해서 서버로 수정한 내용을 전달하여 데이터베이스에 적용 --%>
...
<%@ page import="bitc.fullstack405.study08.database.BoardDTO" %>
            ...
            <div class="row my-3">
                <div class="col-sm">
                    <div class="input-group">
                        ...
                        <%-- input 태그의 수정을 막기 위해서 readonly과 disabled 두 가지 속성을 사용할 수 있음 --%>
                        <%-- 해당 input 태그의 value 속성값을 서버로 전달 시 disabled를 사용하면 name 속성이 있어도 서버로 데이터를 전달하지 않음 --%>
                        <%-- input 태그의 value 속성을 수정하지 않고 서버로 전달 시 readonly를 사용해야 함 --%>
