    ...
    <section>
        <div class="row">
            <div class="col-sm-4 mx-auto border rounded rounded-3 p-3">
                <form action="MemberJoinProcess.jsp" method="post" onsubmit="return validateForm(this);">
...
<%-- ../를 사용하여 현재 디렉토리보다 한 단계 상위 디렉토리를 의미함 --%>
<%-- ../를 사용하여 현재 위치는 webapp 디렉토리가 됨 --%>
<%-- layout/를 사용하여 현재 위치인 webapp 아래에 있는 layout 디렉토리를 선택 --%>
