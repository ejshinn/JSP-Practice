...
<body>
    <div class="container mt-5">
        <h2 class="text-center">useBean 액션 태그</h2><br>
        ...
        <jsp:setProperty name="person" property="name" value="짱구"></jsp:setProperty>
        <jsp:setProperty name="person" property="age" value="5"></jsp:setProperty>

        <h3 class="text-center">getProperty 액션 태그로 자바빈즈 속성 읽기</h3><br>
        <ul class="list-group">
