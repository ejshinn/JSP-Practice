...
<%@ page import="bitc.fullstack405.study05.JDBConnect" %>
...
<head>
    ...
    <title>web.xml에서 DB 접속 정보를 가져와서 DB 접속</title>
...
<body>
    <div class="container mt-5">
        ...
        <%
            // JSP 내장 객체인 application의 getInitParameter() 메서드를 사용하여 web.xml에 존재하는 context-param 태그의 값을 읽어옴
            ...
            // 특수기호가 정상적으로 인식되지 않을 경우 html의 특수기호로 입력 시 정상적으로 인식됨
            dbUrl += "?" + dbOpt1 + "&" + dbOpt2;
        ...
        <%
            // JSP의 내장 객체인 application을 JDBConnect 클래스 생성자의 매개변수로 넘김
